...
(function($) {
	...
	xSquare_item.prototype = {
		...
		create_loader: function() {
			...
			{
				this.$x_loader_holder = $('<div class="x_loader_holder" style="display: none;"><img src="https://calo.zone/public/images/xsquare/ajax-loader.gif" alt="" /></div>');
...
'				<div class="x_loader_holder" style="display: none;"><img src="https://calo.zone/public/images/xsquare/ajax-loader.gif" alt="" /></div>\n'+
